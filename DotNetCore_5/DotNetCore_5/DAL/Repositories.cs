...
namespace DotNetCore_5.DAL
{
    public class Repositories
    {
        public class CustomerRepository : ICustomer
        {
            ...
            {
                CustomerViewModel cus = GetById(id);
            ...
            public CustomerViewModel Save(CustomerViewModel obj)
            {
                ...
                _context.SaveChanges();
                CustomerViewModel obj1 = new CustomerViewModel()
                {
            ...
            public CustomerViewModel Update(CustomerViewModel Upobj)
            {
                Customer customer = new Customer();
